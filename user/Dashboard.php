...
if (isset($_POST["cariTransaksi"])) {
  ...
  if (trim($keyword) == "") {
    ...
    $transaksi = query("SELECT transaksi.*, buku.judul AS judul_buku, users.username AS nama_admin
                            FROM transaksi 
      ...
      <tbody>
        <?php foreach ($transaksi as $row) : ?>
          <tr>
            ...
            <td><?php echo $row['tanggal_pengembalian'] ?? '<p class="text-danger">Belum Dikembalikan!</p>'; ?></td>
